...
type Person struct {
	...
	Name        string                 `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"` // =1 是唯一标识字段的 tag, 用在二进制编码中
...
type AddressBook struct {
	...
	People []*Person `protobuf:"bytes,1,rep,name=people,proto3" json:"people,omitempty"` // repeated 字段是动态长度数组
}
