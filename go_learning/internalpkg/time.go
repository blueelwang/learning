...
func TimeDemo() {
	...
	// 时间的加减
	t, _ = time.ParseInLocation("2006-01-02", "2020-03-31", time.Local)
	fmt.Println(t.Format("2006-01-02 15:04:05"))	// 2020-03-31 00:00:00
	d, _ := time.ParseDuration("86399s")
	fmt.Println(t.Add(d).Format("2006-01-02 15:04:05"))	// 2020-03-31 23:59:59
	fmt.Println(t.Add(86399 * time.Second).Format("2006-01-02 15:04:05"))	// 2020-03-31 23:59:59

	// 时间的比较
	fmt.Println(t.After(t))			// false
